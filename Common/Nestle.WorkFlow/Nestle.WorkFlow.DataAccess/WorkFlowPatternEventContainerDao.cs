...
{
    public class WorkFlowPatternEventContainerDao : BaseDao
    {
        public static int InsertWorkFlowPatternEventContainer(Nestle.WorkFlow.Model.WorkFlowPatternEventContainer model)
        {
            ...
            ExecuteNonQuery("InsertWorkFlowPatternEventContainerProc", sqlParameters.ToArray());
            return (int)id.Value;
        }

        public static int UpdateWorkFlowPatternEventContainer(Nestle.WorkFlow.Model.WorkFlowPatternEventContainer model)
        {
            var sqlParameters = new List<SqlParameter>();
            ...
            return ExecuteNonQuery("UpdateWorkFlowPatternEventContainerProc", sqlParameters.ToArray());
        }

        public static List<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer> GetWorkFlowPatternEventContainer(string procedureName, SqlParameter[] sqlParamters)
        {
            List<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer> li = new List<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer>();
            ...
            if (!string.IsNullOrEmpty(xmlString))
            {
                ...
                {
                    XmlNodeList nodeList = xmlDocument.FirstChild.SelectNodes("//WorkFlowPatternEventContainer");
                    foreach (XmlNode node in nodeList)
                    {
                        li.Add(SerializationHelper.Deserialize<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer>(node.OuterXml));
                    }
                }
            }
        ...
        public static QueryResult<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer> GetWorkFlowPatternEventContainerResult(string procedureName, SqlParameter[] sqlParamters)
        {
            QueryResult<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer> result = new QueryResult<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer>();
            List<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer> li = new List<Nestle.WorkFlow.Model.WorkFlowPatternEventContainer>();

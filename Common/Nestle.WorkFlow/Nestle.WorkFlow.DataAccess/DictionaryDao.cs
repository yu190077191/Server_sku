...
namespace Nestle.WorkFlow.DataAccess
{
    ...
    {
        public static int InsertDictionary(Nestle.WorkFlow.Model.Dictionary model)
        {
        ...
        public static int UpdateDictionary(Nestle.WorkFlow.Model.Dictionary model)
        {
            var sqlParameters = new List<SqlParameter>();
        ...
        public static List<Nestle.WorkFlow.Model.Dictionary> GetDictionary(string procedureName, SqlParameter[] sqlParamters)
        {
            List<Nestle.WorkFlow.Model.Dictionary> li = new List<Nestle.WorkFlow.Model.Dictionary>();
            ...
            if (!string.IsNullOrEmpty(xmlString))
            {
                ...
                if (xmlDocument.HasChildNodes)
                {
                    ...
                    {
                        li.Add(SerializationHelper.Deserialize<Nestle.WorkFlow.Model.Dictionary>(node.OuterXml));
                    }
                }
            }
        ...
        public static QueryResult<Nestle.WorkFlow.Model.Dictionary> GetDictionaryResult(string procedureName, SqlParameter[] sqlParamters)
        {
            QueryResult<Nestle.WorkFlow.Model.Dictionary> result = new QueryResult<Nestle.WorkFlow.Model.Dictionary>();
            List<Nestle.WorkFlow.Model.Dictionary> li = new List<Nestle.WorkFlow.Model.Dictionary>();
